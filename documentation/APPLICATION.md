...
```golang
 ...
 data, err :=  Logistic.GetCountries(xQuery);
```
...
```golang
 ...
 data, err :=  Logistic.GetCountry(CountryIsoCode);
```

| Argument  |  Type  | Description |
| --------- | ----  | --- |

| CountryIsoCode | string | The `country_iso_code` is ISO-2 (alpha-2) code for the country. | 
...
```golang
 ...
 data, err :=  Logistic.GetLocalities(LocalityType, xQuery);
```

| Argument  |  Type  | Description |
| --------- | ----  | --- |

| LocalityType | string | A `locality_type` contains unique geographical division. | 
...
```golang
 ...
 data, err :=  Logistic.GetLocality(LocalityType, LocalityValue, xQuery);
```
