...
data, err := Content.CreatePageV2(CompanyID, ApplicationID, body);
```
...
data, err := Content.GetPagesV2(CompanyID, ApplicationID, xQuery);
```
...
data, err := Content.UpdatePageV2(CompanyID, ApplicationID, ID, body);
```
...
data, err := Content.GetPageBySlugV2(CompanyID, ApplicationID, Slug);
```
