...
func NewAppClient(config *AppConfig) *Client {
    ...
    func (lo *Logistic)  GetCountries(xQuery LogisticGetCountriesXQuery) (GetCountries, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // GetCountry Get single country and associated data.
    func (lo *Logistic)  GetCountry(CountryIsoCode string) (GetCountry, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
        ...
        rawRequest = NewRequest(
            lo.config,
            "get",
            fmt.Sprintf("/service/application/logistics/v1.0/countries/%s",CountryIsoCode),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
    ...
    //LogisticGetLocalitiesXQuery holds query params
    ...
    func (lo *Logistic)  GetLocalities(LocalityType string, xQuery LogisticGetLocalitiesXQuery) (GetLocalities, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
        ...
        rawRequest = NewRequest(
            lo.config,
            "get",
            fmt.Sprintf("/service/application/logistics/v1.0/localities/%s",LocalityType),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    //LogisticGetLocalityXQuery holds query params
    type LogisticGetLocalityXQuery struct { 
        Country string  `url:"country,omitempty"` 
        State string  `url:"state,omitempty"` 
        City string  `url:"city,omitempty"`  
    }
    ...
    func (lo *Logistic)  GetLocality(LocalityType string, LocalityValue string, xQuery LogisticGetLocalityXQuery) (GetLocality, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
        ...
        rawRequest = NewRequest(
            lo.config,
            "get",
            fmt.Sprintf("/service/application/logistics/v1.0/localities/%s/%s",LocalityType,LocalityValue),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
