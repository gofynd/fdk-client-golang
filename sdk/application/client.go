...
func NewAppClient(config *AppConfig) *Client {
    ...
    func (ca *Catalog)  GetProductPriceBySlug(Slug string, Size string, xQuery CatalogGetProductPriceBySlugXQuery) (ProductSizePriceResponse, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    func (ca *Catalog)  GetProductSellersBySlug(Slug string, Size string, xQuery CatalogGetProductSellersBySlugXQuery) (ProductSizeSellersResponse, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
