package application
    ...
    type PromotionOffer struct {
            ...
            FreeGiftItems []map[string]interface{}  `json:"free_gift_items"`
    ...
    type OrderSchema struct {
            ...
            UserInfo ShipmentUserInfo1  `json:"user_info"`
