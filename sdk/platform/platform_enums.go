...
import (
    ...
    const (
            ...
            //SHIPMENT-POLICY defines constant for the `shipment-policy` 
            SHIPMENT-POLICY PageType = "shipment-policy"
