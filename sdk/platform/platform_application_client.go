...
func NewApplicationClient(appID string, config *PlatformConfig) *ApplicationClient {
   ...
   // PlatformAppPayment holds PlatformAppPayment object properties
    ...
    // EdcDevice get details of a single edc device
     func (pa *PlatformAppPayment)  EdcDevice(body  EdcDetailsRequest) (EdcDeviceDetailsResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // EdcDevice Update store id and device tag of edc device
     func (pa *PlatformAppPayment)  EdcDevice(body  EdcUpdateRequest) (EdcDeviceAddUpdateResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            edcDeviceResponse EdcDeviceAddUpdateResponse
	    )
        ...
        if err != nil {
             ...
             return EdcDeviceAddUpdateResponse{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return EdcDeviceAddUpdateResponse{}, err
	    }
    ...
    // EdcDevice map new edc device to the terminal
     func (pa *PlatformAppPayment)  EdcDevice(body  EdcAddRequest) (EdcDeviceAddUpdateResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // EdcDeviceList get all the device list of an app
     func (pa *PlatformAppPayment)  EdcDeviceList() (EdcDeviceListResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
