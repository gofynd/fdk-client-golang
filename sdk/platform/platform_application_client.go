...
func NewApplicationClient(appID string, config *PlatformConfig) *ApplicationClient {
   ...
   // PlatformAppTheme holds PlatformAppTheme object properties
    ...
    // GetDefaultPageDetails Get default page details of a page from page_value
     func (th *PlatformAppTheme)  GetDefaultPageDetails(PageValue string) (AvailablePageSchema, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getDefaultPageDetailsResponse AvailablePageSchema
	    )
        ...
        rawRequest = NewRequest(
            th.config,
            "get",
            fmt.Sprintf("/service/platform/theme/v1.0/company/%s/application/%s/page/%s/default",th.CompanyID, th.ApplicationID, PageValue),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getDefaultPageDetailsResponse)
        if err != nil {
            return AvailablePageSchema{}, common.NewFDKError(err.Error())
        }
        return getDefaultPageDetailsResponse, nil
    ...
    // GetApplicationThemesV2 Get all the themes for a specific application
     func (th *PlatformAppTheme)  GetApplicationThemesV2() ([]AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getApplicationThemesV2Response []AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &getApplicationThemesV2Response)
        if err != nil {
            return []AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return getApplicationThemesV2Response, nil
    ...
    // GetFontsV2 Get all the supported fonts in a theme
     func (th *PlatformAppTheme)  GetFontsV2() (FontsSchema, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getFontsV2Response FontsSchema
	    )
        ...
        rawRequest = NewRequest(
            th.config,
            "get",
            fmt.Sprintf("/service/platform/theme/v2.0/company/%s/application/%s/fonts",th.CompanyID, th.ApplicationID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getFontsV2Response)
        if err != nil {
            return FontsSchema{}, common.NewFDKError(err.Error())
        }
        return getFontsV2Response, nil
    ...
    // GetApplicationThemesCountV2 Get the count of themes for a specific application
     func (th *PlatformAppTheme)  GetApplicationThemesCountV2() (map[string]interface{}, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getApplicationThemesCountV2Response map[string]interface{}
	    )
        ...
        err = json.Unmarshal(response, &getApplicationThemesCountV2Response)
        if err != nil {
            return map[string]interface{}{}, common.NewFDKError(err.Error())
        }
        return getApplicationThemesCountV2Response, nil
    ...
    // GetApplicationThemeByIdV2 Get Theme By Theme Id
     func (th *PlatformAppTheme)  GetApplicationThemeByIdV2(ThemeID string) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getApplicationThemeByIdV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &getApplicationThemeByIdV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return getApplicationThemeByIdV2Response, nil
    ...
    // UpdateThemeV2 Update theme for a specific company and application
     func (th *PlatformAppTheme)  UpdateThemeV2(ThemeID string, body  UpdateThemeRequestBodyV2) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateThemeV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &updateThemeV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return updateThemeV2Response, nil
    ...
    // DeleteThemeV2 Delete a theme
     func (th *PlatformAppTheme)  DeleteThemeV2(ThemeID string) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            deleteThemeV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &deleteThemeV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return deleteThemeV2Response, nil
    ...
    // AddThemeToApplicationV2 Apply a theme to an application
     func (th *PlatformAppTheme)  AddThemeToApplicationV2(body  ApplyThemeRequestV2) (ApplyThemeResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            addThemeToApplicationV2Response ApplyThemeResponseV2
	    )
        ...
        if err != nil {
             ...
             return ApplyThemeResponseV2{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return ApplyThemeResponseV2{}, err
	    }
        
        err = json.Unmarshal(response, &addThemeToApplicationV2Response)
        if err != nil {
            return ApplyThemeResponseV2{}, common.NewFDKError(err.Error())
        }
        return addThemeToApplicationV2Response, nil
    ...
    // GetAppliedThemeV2 Get the Applied theme of an Application
     func (th *PlatformAppTheme)  GetAppliedThemeV2() (ApplyThemeResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getAppliedThemeV2Response ApplyThemeResponseV2
	    )
    ...
    // ApplyThemeV2 Apply theme to a specific application
     func (th *PlatformAppTheme)  ApplyThemeV2(ThemeID string) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            applyThemeV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &applyThemeV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return applyThemeV2Response, nil
    ...
    // DuplicateThemeV2 Duplicate a Theme
     func (th *PlatformAppTheme)  DuplicateThemeV2(ThemeID string) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            duplicateThemeV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &duplicateThemeV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return duplicateThemeV2Response, nil
    ...
    // GetThemePreviewByIdV2 Get Theme Preview By Theme Id
     func (th *PlatformAppTheme)  GetThemePreviewByIdV2(ThemeID string) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getThemePreviewByIdV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &getThemePreviewByIdV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return getThemePreviewByIdV2Response, nil
    ...
    // GetThemeLastModifiedV2 Fetch last modified timestamp
     func (th *PlatformAppTheme)  GetThemeLastModifiedV2(ThemeID string) (interface{}, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // CheckThemeUpgradableV2 Check if the theme is upgradable
     func (th *PlatformAppTheme)  CheckThemeUpgradableV2(ThemeID string) (ThemeUpgradableResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            checkThemeUpgradableV2Response ThemeUpgradableResponseV2
	    )
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return ThemeUpgradableResponseV2{}, err
	    }
        
        err = json.Unmarshal(response, &checkThemeUpgradableV2Response)
        if err != nil {
            return ThemeUpgradableResponseV2{}, common.NewFDKError(err.Error())
        }
        return checkThemeUpgradableV2Response, nil
    ...
    // UpgradeApplicationV2 Upgrade an application
     func (th *PlatformAppTheme)  UpgradeApplicationV2(ThemeID string) (AllThemesApplicationResponseV2, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            upgradeApplicationV2Response AllThemesApplicationResponseV2
	    )
        ...
        err = json.Unmarshal(response, &upgradeApplicationV2Response)
        if err != nil {
            return AllThemesApplicationResponseV2{}, common.NewFDKError(err.Error())
        }
        return upgradeApplicationV2Response, nil
   ...
   // PlatformAppCommunication holds PlatformAppCommunication object properties
    ...
    // CreateEmailTemplate Create email template
     func (co *PlatformAppCommunication)  CreateEmailTemplate(body  EmailTemplateReq) (EmailTemplate, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            createEmailTemplateResponse EmailTemplate
	    )
    ...
    // GetSystemEmailTemplates Get system email templates
     func (co *PlatformAppCommunication)  GetSystemEmailTemplates() (SystemEmailTemplates, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // UpdateEmailTemplateById Update email template by id
     func (co *PlatformAppCommunication)  UpdateEmailTemplateById(ID string, body  EmailTemplateReq) (EmailTemplate, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateEmailTemplateByIdResponse EmailTemplate
	    )
    ...
    // DeleteEmailTemplateById Delete email template by id
     func (co *PlatformAppCommunication)  DeleteEmailTemplateById(ID string) (GenericDelete, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            deleteEmailTemplateByIdResponse GenericDelete
	    )
    ...
    //PlatformAppGetSubscribedEmailTemplatesXQuery holds query params
    type PlatformAppGetSubscribedEmailTemplatesXQuery struct { 
        PageNo float64  `url:"page_no,omitempty"` 
        PageSize float64  `url:"page_size,omitempty"`  
    }
    
    // GetSubscribedEmailTemplates Get subscribed email templates
     func (co *PlatformAppCommunication)  GetSubscribedEmailTemplates(xQuery PlatformAppGetSubscribedEmailTemplatesXQuery) (EmailTemplates, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getSubscribedEmailTemplatesResponse EmailTemplates
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/email/subscribedTemplates",co.CompanyID, co.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getSubscribedEmailTemplatesResponse)
        if err != nil {
            return EmailTemplates{}, common.NewFDKError(err.Error())
        }
        return getSubscribedEmailTemplatesResponse, nil
    ...
    // GetGlobalVariables get global variables
     func (co *PlatformAppCommunication)  GetGlobalVariables() (GlobalVariablesGetResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getGlobalVariablesResponse GlobalVariablesGetResponse
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/global-variables",co.CompanyID, co.ApplicationID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
            return GlobalVariablesGetResponse{}, err
	    }
        
        err = json.Unmarshal(response, &getGlobalVariablesResponse)
        if err != nil {
            return GlobalVariablesGetResponse{}, common.NewFDKError(err.Error())
        }
        return getGlobalVariablesResponse, nil
    ...
    // PostGlobalVariables post global variables
     func (co *PlatformAppCommunication)  PostGlobalVariables(body  GlobalVariablesReq) (GlobalVariablesPostResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            postGlobalVariablesResponse GlobalVariablesPostResponse
	    )
        ...
        if err != nil {
             ...
             return GlobalVariablesPostResponse{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return GlobalVariablesPostResponse{}, err
	    }
        
        err = json.Unmarshal(response, &postGlobalVariablesResponse)
        if err != nil {
            return GlobalVariablesPostResponse{}, common.NewFDKError(err.Error())
        }
        return postGlobalVariablesResponse, nil
    ...
    //PlatformAppGetVoiceProvidersXQuery holds query params
    type PlatformAppGetVoiceProvidersXQuery struct { 
        PageNo float64  `url:"page_no,omitempty"` 
        PageSize float64  `url:"page_size,omitempty"` 
        Sort map[string]interface{}  `url:"sort,omitempty"`  
    }
    
    // GetVoiceProviders Get voice providers
     func (co *PlatformAppCommunication)  GetVoiceProviders(xQuery PlatformAppGetVoiceProvidersXQuery) (VoiceProviders, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getVoiceProvidersResponse VoiceProviders
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/voice/providers",co.CompanyID, co.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getVoiceProvidersResponse)
        if err != nil {
            return VoiceProviders{}, common.NewFDKError(err.Error())
        }
        return getVoiceProvidersResponse, nil
    ...
    // CreateVoiceProvider Create voice provider
     func (co *PlatformAppCommunication)  CreateVoiceProvider(body  VoiceProviderReq) (VoiceProvider, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            createVoiceProviderResponse VoiceProvider
	    )
        ...
        if err != nil {
             ...
             return VoiceProvider{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        err = json.Unmarshal(response, &createVoiceProviderResponse)
        if err != nil {
            return VoiceProvider{}, common.NewFDKError(err.Error())
        }
        return createVoiceProviderResponse, nil
    ...
    // GetVoiceProviderById Get voice provider by id
     func (co *PlatformAppCommunication)  GetVoiceProviderById(ID string) (VoiceProvider, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getVoiceProviderByIdResponse VoiceProvider
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/voice/providers/%s",co.CompanyID, co.ApplicationID, ID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getVoiceProviderByIdResponse)
        if err != nil {
            return VoiceProvider{}, common.NewFDKError(err.Error())
        }
        return getVoiceProviderByIdResponse, nil
    ...
    //PlatformAppGetVoiceTemplatesXQuery holds query params
    type PlatformAppGetVoiceTemplatesXQuery struct { 
        PageNo float64  `url:"page_no,omitempty"` 
        PageSize float64  `url:"page_size,omitempty"` 
        Sort map[string]interface{}  `url:"sort,omitempty"`  
    }
    
    // GetVoiceTemplates Get voice templates
     func (co *PlatformAppCommunication)  GetVoiceTemplates(xQuery PlatformAppGetVoiceTemplatesXQuery) (VoiceTemplates, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getVoiceTemplatesResponse VoiceTemplates
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/voice/templates",co.CompanyID, co.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
            return VoiceTemplates{}, err
	    }
        
        err = json.Unmarshal(response, &getVoiceTemplatesResponse)
        if err != nil {
            return VoiceTemplates{}, common.NewFDKError(err.Error())
        }
        return getVoiceTemplatesResponse, nil
    ...
    // CreateVoiceTemplate Create voice template
     func (co *PlatformAppCommunication)  CreateVoiceTemplate(body  VoiceTemplateReq) (VoiceTemplateRes, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            createVoiceTemplateResponse VoiceTemplateRes
	    )
        ...
        if err != nil {
             ...
             return VoiceTemplateRes{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return VoiceTemplateRes{}, err
	    }
        
        err = json.Unmarshal(response, &createVoiceTemplateResponse)
        if err != nil {
            return VoiceTemplateRes{}, common.NewFDKError(err.Error())
        }
        return createVoiceTemplateResponse, nil
    ...
    // GetVoiceTemplateById Get voice template by id
     func (co *PlatformAppCommunication)  GetVoiceTemplateById(ID string) (VoiceTemplate, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getVoiceTemplateByIdResponse VoiceTemplate
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/voice/templates/%s",co.CompanyID, co.ApplicationID, ID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
            return VoiceTemplate{}, err
	    }
        
        err = json.Unmarshal(response, &getVoiceTemplateByIdResponse)
        if err != nil {
            return VoiceTemplate{}, common.NewFDKError(err.Error())
        }
        return getVoiceTemplateByIdResponse, nil
    ...
    // UpdateVoiceTemplateById Update voice template by id
     func (co *PlatformAppCommunication)  UpdateVoiceTemplateById(ID string, body  VoiceTemplateReq) (VoiceTemplateRes, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateVoiceTemplateByIdResponse VoiceTemplateRes
	    )
        ...
        err = json.Unmarshal(response, &updateVoiceTemplateByIdResponse)
        if err != nil {
            return VoiceTemplateRes{}, common.NewFDKError(err.Error())
        }
        return updateVoiceTemplateByIdResponse, nil
    ...
    // DeleteVoiceTemplateById Delete voice template by id
     func (co *PlatformAppCommunication)  DeleteVoiceTemplateById(ID string) (VoiceTemplateDeleteSuccessRes, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            deleteVoiceTemplateByIdResponse VoiceTemplateDeleteSuccessRes
	    )
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return VoiceTemplateDeleteSuccessRes{}, err
	    }
        
        err = json.Unmarshal(response, &deleteVoiceTemplateByIdResponse)
        if err != nil {
            return VoiceTemplateDeleteSuccessRes{}, common.NewFDKError(err.Error())
        }
        return deleteVoiceTemplateByIdResponse, nil
    ...
    //PlatformAppGetSystemVoiceTemplatesXQuery holds query params
    type PlatformAppGetSystemVoiceTemplatesXQuery struct { 
        PageNo float64  `url:"page_no,omitempty"` 
        PageSize float64  `url:"page_size,omitempty"` 
        Sort map[string]interface{}  `url:"sort,omitempty"`  
    }
    
    // GetSystemVoiceTemplates Get system voice templates
     func (co *PlatformAppCommunication)  GetSystemVoiceTemplates(xQuery PlatformAppGetSystemVoiceTemplatesXQuery) (SystemVoiceTemplates, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getSystemVoiceTemplatesResponse SystemVoiceTemplates
	    )
        ...
        rawRequest = NewRequest(
            co.config,
            "get",
            fmt.Sprintf("/service/platform/communication/v1.0/company/%s/application/%s/voice/system-templates",co.CompanyID, co.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
            return SystemVoiceTemplates{}, err
	    }
        
        err = json.Unmarshal(response, &getSystemVoiceTemplatesResponse)
        if err != nil {
            return SystemVoiceTemplates{}, common.NewFDKError(err.Error())
        }
        return getSystemVoiceTemplatesResponse, nil
    ...
    // GetApplicationShipments 
     func (or *PlatformAppOrder)  GetApplicationShipments(xQuery PlatformAppGetApplicationShipmentsXQuery) (ShipmentInternalPlatformViewResponse, error) {
        ...
        rawRequest = NewRequest(
            or.config,
            "get",
            fmt.Sprintf("/service/platform/order/v1.0/company/%s/application/%s/shipments/",or.CompanyID, or.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // GetAppOrderShipmentDetails 
     func (or *PlatformAppOrder)  GetAppOrderShipmentDetails(xQuery PlatformAppGetAppOrderShipmentDetailsXQuery) (OrderDetailsResponse, error) {
        ...
        rawRequest = NewRequest(
            or.config,
            "get",
            fmt.Sprintf("/service/platform/order/v1.0/company/%s/application/%s/order-details",or.CompanyID, or.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
   ...
   // PlatformAppCatalog holds PlatformAppCatalog object properties
    ...
    //PlatformAppGetProductSizeSellersXQuery holds query params
    type PlatformAppGetProductSizeSellersXQuery struct { 
        Pincode string  `url:"pincode,omitempty"` 
    ...
    // GetProductSizeSellers Get the sellers of a product size at a PIN Code
     func (ca *PlatformAppCatalog)  GetProductSizeSellers(ItemID string, Size string, xQuery PlatformAppGetProductSizeSellersXQuery) (ProductSizeSellersResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getProductSizeSellersResponse ProductSizeSellersResponse
	    )
        ...
        rawRequest = NewRequest(
            ca.config,
            "get",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/application/%s/products/%s/sizes/%s/sellers/",ItemID, ca.CompanyID, ca.ApplicationID, Size),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getProductSizeSellersResponse)
        if err != nil {
            return ProductSizeSellersResponse{}, common.NewFDKError(err.Error())
        }
        return getProductSizeSellersResponse, nil
            ...
            // GetProductSizeSellersPaginator Get the sellers of a product size at a PIN Code  
            func (ca *PlatformAppCatalog)  GetProductSizeSellersPaginator(ItemID string , Size string ,  xQuery PlatformAppGetProductSizeSellersXQuery ) *common.Paginator {
                paginator := common.NewPaginator("number")
                ...
                paginator.Next = func() (interface{}, error) {
                    response, err := ca.GetProductSizeSellers(ItemID, Size, xQuery)
                    if response.Page.HasNext {
                        paginator.SetPaginator(response.Page.HasNext, int(response.Page.Current+1), response.Page.NextID)
                    }
                    return response, err
   ...
   // PlatformAppCart holds PlatformAppCart object properties
    ...
    // UpdateCartDynamicInjection Update cart injection configuration
     func (ca *PlatformAppCart)  UpdateCartDynamicInjection(ID string, body  CartDynamicInjectionUpdate) (CartDynamicInjectionResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateCartDynamicInjectionResponse CartDynamicInjectionResponse
	    )
        ...
        if err != nil {
             ...
             return CartDynamicInjectionResponse{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        rawRequest = NewRequest(
            ca.config,
            "put",
            fmt.Sprintf("/service/platform/cart/v1.0/company/%s/application/%s/additional-charge-discount/%s",ca.CompanyID, ca.ApplicationID, ID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
        if err != nil {
            return CartDynamicInjectionResponse{}, err
	    }
        
        err = json.Unmarshal(response, &updateCartDynamicInjectionResponse)
        if err != nil {
            return CartDynamicInjectionResponse{}, common.NewFDKError(err.Error())
        }
        return updateCartDynamicInjectionResponse, nil
    ...
    // CreateCartDynamicInjection Create new cart dynamic injection
     func (ca *PlatformAppCart)  CreateCartDynamicInjection(body  CartDynamicInjectionAdd) (CartDynamicInjectionResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
        ...
        rawRequest = NewRequest(
            ca.config,
            "post",
            fmt.Sprintf("/service/platform/cart/v1.0/company/%s/application/%s/additional-charge-discount",ca.CompanyID, ca.ApplicationID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &createCartDynamicInjectionResponse)
        if err != nil {
            return CartDynamicInjectionResponse{}, common.NewFDKError(err.Error())
        }
        return createCartDynamicInjectionResponse, nil
    ...
    //PlatformAppGetCartListXQuery holds query params
    type PlatformAppGetCartListXQuery struct { 
        FromDate string  `url:"from_date,omitempty"` 
        ToDate string  `url:"to_date,omitempty"` 
        FilterOn string  `url:"filter_on,omitempty"`  
    }
    ...
    // PlatformAddItems Add items to cart
     func (ca *PlatformAppCart)  PlatformAddItems(xQuery PlatformAppPlatformAddItemsXQuery, body  PlatformAddCartRequest) (AddCartDetailResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // PlatformUpdateCart Update items in the customer 's cart using cart id
     func (ca *PlatformAppCart)  PlatformUpdateCart(xQuery PlatformAppPlatformUpdateCartXQuery, body  PlatformUpdateCartRequest) (UpdateCartDetailResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // DeleteCart Delete cart once user made successful checkout
     func (ca *PlatformAppCart)  DeleteCart(xQuery PlatformAppDeleteCartXQuery, body  DeleteCartRequest) (DeleteCartDetailResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // GetShipments Get delivery date and options before checkout
     func (ca *PlatformAppCart)  GetShipments(xQuery PlatformAppGetShipmentsXQuery) (PlatformCartShipmentsResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getShipmentsResponse PlatformCartShipmentsResponse
	    )
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return PlatformCartShipmentsResponse{}, err
	    }
        
        err = json.Unmarshal(response, &getShipmentsResponse)
        if err != nil {
            return PlatformCartShipmentsResponse{}, common.NewFDKError(err.Error())
        }
    ...
    // UpdateShipments Update shipment delivery type and quantity before checkout
     func (ca *PlatformAppCart)  UpdateShipments(xQuery PlatformAppUpdateShipmentsXQuery, body  UpdateCartShipmentRequest) (PlatformCartShipmentsResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateShipmentsResponse PlatformCartShipmentsResponse
	    )
    ...
    // PlatformCheckoutCartV2 Checkout all items in the cart
     func (ca *PlatformAppCart)  PlatformCheckoutCartV2(xQuery PlatformAppPlatformCheckoutCartV2XQuery, body  PlatformCartCheckoutDetailV2Request) (CartCheckoutResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            platformCheckoutCartV2Response CartCheckoutResponse
	    )
