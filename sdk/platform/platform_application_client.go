...
func NewApplicationClient(appID string, config *PlatformConfig) *ApplicationClient {
		return &ApplicationClient{
			...
			ApplicationID: appID,
				...
				Orders:  NewPlatformAppOrders(config, appID),
   ...
   // PlatformAppOrder holds PlatformAppOrder object properties
    ...
    type PlatformAppGetOrdersByApplicationIdXQuery struct { 
        ...
        ShortenUrls string  `url:"shorten_urls,omitempty"` 
   ...
   // PlatformAppCatalog holds PlatformAppCatalog object properties
    ...
    //PlatformAppGetAppProductXQuery holds query params
    type PlatformAppGetAppProductXQuery struct { 
        SliceAttr string  `url:"slice_attr,omitempty"`  
    }
    
    // GetAppProduct Get company application product data.
     func (ca *PlatformAppCatalog)  GetAppProduct(ItemID string, xQuery PlatformAppGetAppProductXQuery) (ApplicationItemResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getAppProductResponse ApplicationItemResponse
	    )
        ...
        response, err = rawRequest.Execute()
        if err != nil {
            return ApplicationItemResponse{}, err
	    }
        
        err = json.Unmarshal(response, &getAppProductResponse)
        if err != nil {
            return ApplicationItemResponse{}, common.NewFDKError(err.Error())
        }
    ...
    // GetConfigurationMetadata Get configuration metadata details for catalog for admin panel
     func (ca *PlatformAppCatalog)  GetConfigurationMetadata(ConfigType string, xQuery PlatformAppGetConfigurationMetadataXQuery) (GetConfigMetadataResponse, error) {
        ...
        rawRequest = NewRequest(
            ca.config,
            "get",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/application/%s/product-configuration/%s/metadata/",ca.CompanyID, ca.ApplicationID, ConfigType),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // GetGroupConfigurations Get the details of the application configured configurations of group config types.
     func (ca *PlatformAppCatalog)  GetGroupConfigurations(ConfigType string, xQuery PlatformAppGetGroupConfigurationsXQuery) (GetConfigResponse, error) {
        ...
        rawRequest = NewRequest(
            ca.config,
            "get",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/application/%s/product-configuration/%s/groups",ca.CompanyID, ca.ApplicationID, ConfigType),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // GetListingConfigurations Get the details of the application configured configurations of listing config types.
     func (ca *PlatformAppCatalog)  GetListingConfigurations(ConfigType string, xQuery PlatformAppGetListingConfigurationsXQuery) (GetConfigResponse, error) {
        ...
        rawRequest = NewRequest(
            ca.config,
            "get",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/application/%s/product-configuration/%s/",ca.CompanyID, ca.ApplicationID, ConfigType),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // UpdateAllowSingle Update allow single flag for filters of the application.
     func (ca *PlatformAppCatalog)  UpdateAllowSingle(body  AllowSingleRequest) (ConfigSuccessResponse, error) {
        ...
        rawRequest = NewRequest(
            ca.config,
            "post",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/application/%s/product-configuration/filter/allow_single",ca.CompanyID, ca.ApplicationID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
    ...
    // UpdateDefaultSort Update the default sort key configuration for the application.
     func (ca *PlatformAppCatalog)  UpdateDefaultSort(body  DefaultKeyRequest) (ConfigSuccessResponse, error) {
        ...
        rawRequest = NewRequest(
            ca.config,
            "post",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/application/%s/product-configuration/sort/default_key",ca.CompanyID, ca.ApplicationID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
   ...
   // PlatformAppOrders holds PlatformAppOrders object properties
    type PlatformAppOrders struct {
        config *PlatformConfig
        CompanyID string
        ApplicationID string
    }
    // NewPlatformAppOrders returns new PlatformAppOrders instance
    func NewPlatformAppOrders(config *PlatformConfig, appID string) *PlatformAppOrders {
        return &PlatformAppOrders{config, config.CompanyID, appID}
    }
    ...
    //PlatformAppGetLaneConfigCrossSellingDataXQuery holds query params
    type PlatformAppGetLaneConfigCrossSellingDataXQuery struct { 
    ...
    // GetLaneConfigCrossSellingData 
     func (or *PlatformAppOrders)  GetLaneConfigCrossSellingData(xQuery PlatformAppGetLaneConfigCrossSellingDataXQuery) (LaneConfigResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getLaneConfigCrossSellingDataResponse LaneConfigResponse
	    )
        ...
        rawRequest = NewRequest(
            or.config,
            "get",
            fmt.Sprintf("/service/platform/orders/v1.0/company/%s/application/%s/lane-config/",or.CompanyID, or.ApplicationID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &getLaneConfigCrossSellingDataResponse)
        if err != nil {
            return LaneConfigResponse{}, common.NewFDKError(err.Error())
        }
        return getLaneConfigCrossSellingDataResponse, nil
    ...
    // GetApplicationShipments 
     func (or *PlatformAppOrders)  GetApplicationShipments(xQuery PlatformAppGetApplicationShipmentsXQuery) (ShipmentInternalPlatformViewResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // GetAppOrderShipmentDetails 
     func (or *PlatformAppOrders)  GetAppOrderShipmentDetails(xQuery PlatformAppGetAppOrderShipmentDetailsXQuery) (ShipmentDetailsResponse, error) {
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
