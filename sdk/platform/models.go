package platform
    ...
    // ManualStoreReassign used by OrderManage
    type ManualStoreReassign struct {
    ...
    // ManualStoreReassignResponse used by OrderManage
    type ManualStoreReassignResponse struct {
