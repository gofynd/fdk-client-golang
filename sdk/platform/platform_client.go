...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformOrderManage holds PlatformOrderManage object properties
    ...
    // ManualStoreReassignment 
     func (or *PlatformOrderManage)  ManualStoreReassignment(body  ManualStoreReassign) (SuccessResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            manualStoreReassignmentResponse SuccessResponse
	    )
        ...
        rawRequest = NewRequest(
            or.Config,
            "post",
            fmt.Sprintf("/service/platform/order-manage/v1.0/company/%s/store/manual-reassign",or.CompanyID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &manualStoreReassignmentResponse)
        if err != nil {
             return SuccessResponse{}, common.NewFDKError(err.Error())
        }
        return manualStoreReassignmentResponse, nil
    ...
    // ShipmentEDDUpdate 
     func (or *PlatformOrderManage)  ShipmentEDDUpdate(body  ShipmentEDDUpdate) (SuccessResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            shipmentEDDUpdateResponse SuccessResponse
	    )
        ...
        rawRequest = NewRequest(
            or.Config,
            "post",
            fmt.Sprintf("/service/platform/order-manage/v1.0/company/%s/shipment/edd-update",or.CompanyID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &shipmentEDDUpdateResponse)
        if err != nil {
             return SuccessResponse{}, common.NewFDKError(err.Error())
        }
        return shipmentEDDUpdateResponse, nil
