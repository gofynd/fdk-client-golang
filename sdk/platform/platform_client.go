...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformPayment holds PlatformPayment object properties
    ...
    // GetSubscriptionPaymentMethod List Subscription Payment Method
     func (pa *PlatformPayment)  GetSubscriptionPaymentMethod() (SubscriptionPaymentMethodResponse, error){
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    // GetInventoryBySizeIdentifier Get Inventory for company
     func (ca *PlatformCatalog)  GetInventoryBySizeIdentifier(ItemID string, SizeIdentifier string, xQuery PlatformGetInventoryBySizeIdentifierXQuery) (InventoryResponse, error){
        ...
        rawRequest = NewRequest(
            ca.Config,
            "get",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/products/<item_id:int>/sizes/<size_identifier>",ca.CompanyID, ItemID, SizeIdentifier),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // DeleteInventory Delete a Inventory.
     func (ca *PlatformCatalog)  DeleteInventory(ItemID float64, LocationID float64) (InventoryDelete, error){
    ...
    // CreateBulkInventory Create products in bulk associated with given batch Id.
     func (ca *PlatformCatalog)  CreateBulkInventory(body  InventoryBulkRequest) (SuccessResponse, error){
   ...
   // PlatformInventory holds PlatformInventory object properties
    ...
    // GetJobCodeMetrics Get Job Metrics
     func (in *PlatformInventory)  GetJobCodeMetrics(Code string) (ResponseEnvelopeJobMetricsDto, error){
   ...
   // PlatformWebhook holds PlatformWebhook object properties
    ...
    // GetSubscribersByCompanyAndEventId Get Subscribers By Company And Event
     func (we *PlatformWebhook)  GetSubscribersByCompanyAndEventId(EventID float64, xQuery PlatformGetSubscribersByCompanyAndEventIdXQuery) (SubscriberConfigList, error){
        ...
        rawRequest = NewRequest(
            we.Config,
            "get",
            fmt.Sprintf("/service/platform/webhook/v1.0/company/%s/subscriber/undefined",we.CompanyID, EventID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
