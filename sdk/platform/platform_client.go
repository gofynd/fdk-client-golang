...
func NewPlatformClient(config *PlatformConfig) *PlatformClient {
		return &PlatformClient{
			config: config,
				...
				Logistic:  NewPlatformLogistic(config),
...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformOrder holds PlatformOrder object properties
    ...
    // GetShipmentById 
     func (or *PlatformOrder)  GetShipmentById(ChannelShipmentID string, xQuery PlatformGetShipmentByIdXQuery) (ShipmentInfoResponse, error){
    ...
    // GetManifestList 
     func (or *PlatformOrder)  GetManifestList(xQuery PlatformGetManifestListXQuery) (GeneratedManifestResponse, error){
    ...
    // GetManifestDetailsWithShipments 
     func (or *PlatformOrder)  GetManifestDetailsWithShipments(xQuery PlatformGetManifestDetailsWithShipmentsXQuery) (ManifestDetailResponse, error){
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    // CreateProduct Create a product.
     func (ca *PlatformCatalog)  CreateProduct(body  ProductCreateUpdateRequest) (SuccessResponse, error){
    ...
    // CreateProductV2 Create a product.
     func (ca *PlatformCatalog)  CreateProductV2(body  ProductCreateUpdateSchemaV2) (SuccessResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            createProductV2Response SuccessResponse
	    )
        ...
        err = json.Unmarshal(response, &createProductV2Response)
        if err != nil {
             return SuccessResponse{}, common.NewFDKError(err.Error())
        }
        return createProductV2Response, nil
    ...
    // EditProduct Edit a product.
     func (ca *PlatformCatalog)  EditProduct(ItemID float64, body  ProductCreateUpdateRequest) (SuccessResponse, error){
    ...
    // PatchProduct Patch a product.
     func (ca *PlatformCatalog)  PatchProduct(ItemID float64, body  ProductPatch) (SuccessResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            patchProductResponse SuccessResponse
	    )
        ...
        err = json.Unmarshal(response, &patchProductResponse)
        if err != nil {
             return SuccessResponse{}, common.NewFDKError(err.Error())
        }
        return patchProductResponse, nil
    ...
    //PlatformGetProductV2XQuery holds query params
    type PlatformGetProductV2XQuery struct { 
        ItemCode string  `url:"item_code,omitempty"` 
        BrandUID float64  `url:"brand_uid,omitempty"`  
    }
    ...
    // GetProductV2 Get a single product.
     func (ca *PlatformCatalog)  GetProductV2(ItemID float64, xQuery PlatformGetProductV2XQuery) (Product, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getProductV2Response Product
	    )
        ...
        err = json.Unmarshal(response, &getProductV2Response)
        if err != nil {
             return Product{}, common.NewFDKError(err.Error())
        }
        return getProductV2Response, nil
    ...
    // EditProductV2 Edit a product.
     func (ca *PlatformCatalog)  EditProductV2(ItemID float64, body  ProductCreateUpdateSchemaV2) (SuccessResponseProduct, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            editProductV2Response SuccessResponseProduct
	    )
        ...
        if err != nil {
             ...
             return SuccessResponseProduct{}, common.NewFDKError(err.Error())
        }
        err = json.Unmarshal([]byte(reqBodyJSON), &reqBody)
        if err != nil {
        ...
        response, err = rawRequest.Execute()
        if err != nil {
             return SuccessResponseProduct{}, err
	    }
        
        err = json.Unmarshal(response, &editProductV2Response)
        if err != nil {
             return SuccessResponseProduct{}, common.NewFDKError(err.Error())
        }
        return editProductV2Response, nil
    ...
    // AllSizes All Sizes for a given Product
     func (ca *PlatformCatalog)  AllSizes(ItemID float64) (ListALLSizes, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            allSizesResponse ListALLSizes
	    )
        ...
        response, err = rawRequest.Execute()
        if err != nil {
             return ListALLSizes{}, err
	    }
        
        err = json.Unmarshal(response, &allSizesResponse)
        if err != nil {
             return ListALLSizes{}, common.NewFDKError(err.Error())
        }
    ...
    // GetIntegrationLevelConfig Get integration level config
     func (co *PlatformConfiguration)  GetIntegrationLevelConfig(ID string, Level string, xQuery PlatformGetIntegrationLevelConfigXQuery) (IntegrationConfigResponse, error){
        ...
        rawRequest = NewRequest(
            co.Config,
            "get",
            fmt.Sprintf("/service/platform/configuration/v1.0/company/%s/integration-opt-in/configuration/new/%s/%s",co.CompanyID, ID, Level),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
   ...
   // PlatformLogistic holds PlatformLogistic object properties
    type PlatformLogistic struct {
        Config *PlatformConfig
        CompanyID string
    }
    // NewPlatformLogistic returns new PlatformLogistic instance
    func NewPlatformLogistic(config *PlatformConfig) *PlatformLogistic {
        return &PlatformLogistic{Config: config, CompanyID: config.CompanyID}
    }
    ...
    // GetEntityRegionView Get country and state list
     func (lo *PlatformLogistic)  GetEntityRegionView(body  EntityRegionView_Request) (EntityRegionView_Response, error){
    ...
    // GetListView Zone List of application.
     func (lo *PlatformLogistic)  GetListView(xQuery PlatformGetListViewXQuery) (ListViewResponse, error){
    ...
    // GetZoneDataView Zone Data View of application.
     func (lo *PlatformLogistic)  GetZoneDataView(ZoneID string) (GetSingleZoneDataViewResponse, error){
    ...
    // UpdateZoneControllerView Updation of zone collections in database.
     func (lo *PlatformLogistic)  UpdateZoneControllerView(ZoneID string, body  ZoneUpdateRequest) (ZoneSuccessResponse, error){
    ...
    // InsertZoneControllerView Insertion of zone in database.
     func (lo *PlatformLogistic)  InsertZoneControllerView(body  ZoneRequest) (ZoneResponse, error){
    ...
    // GetStore GET stores data
     func (lo *PlatformLogistic)  GetStore(StoreUID float64) (GetStoresViewResponse, error){
    ...
    // GetAllStores GET stores data
     func (lo *PlatformLogistic)  GetAllStores() (GetStoresViewResponse, error){
