...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    // GetProductV2 Get a single product.
     func (ca *PlatformCatalog)  GetProductV2(ItemID float64, xQuery PlatformGetProductV2XQuery) (ProductResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getProductV2Response ProductResponse
	    )
        ...
        if err != nil {
             return ProductResponse{}, common.NewFDKError(err.Error())
        }
