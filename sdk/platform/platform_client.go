...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformOrder holds PlatformOrder object properties
    ...
    // GetShipmentToManifest 
     func (or *PlatformOrder)  GetShipmentToManifest(xQuery PlatformGetShipmentToManifestXQuery) (ManifestShipmentResponse, error){
    ...
    // StatusInternalUpdate 
     func (or *PlatformOrder)  StatusInternalUpdate(body  PlatformShipmentStatusInternal) (ResponseDetail, error){
