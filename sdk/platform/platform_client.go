...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformOrder holds PlatformOrder object properties
    ...
    // StatusUpdateInternalV4 
     func (or *PlatformOrder)  StatusUpdateInternalV4(body  StatusUpdateInternalRequest) (StatusUpdateInternalResponse, error){
    ...
    // GetShipmentList 
     func (or *PlatformOrder)  GetShipmentList(xQuery PlatformGetShipmentListXQuery) (ShipmentInternalPlatformViewResponse, error){
    ...
    // GetShipmentDetails 
     func (or *PlatformOrder)  GetShipmentDetails(ShipmentID string, xQuery PlatformGetShipmentDetailsXQuery) (ShipmentInfoResponse, error){
    ...
    // GetOrderShipmentDetails 
     func (or *PlatformOrder)  GetOrderShipmentDetails(xQuery PlatformGetOrderShipmentDetailsXQuery) (ShipmentDetailsResponse, error){
    ...
    // GetPlatformShipmentReasons1 Get reasons behind full or partial cancellation of a shipment
     func (or *PlatformOrder)  GetPlatformShipmentReasons1(ShipmentID string, BagID string, State string) (PlatformShipmentReasonsResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getPlatformShipmentReasons1Response PlatformShipmentReasonsResponse
	    )
        ...
        err = json.Unmarshal(response, &getPlatformShipmentReasons1Response)
        if err != nil {
             return PlatformShipmentReasonsResponse{}, common.NewFDKError(err.Error())
        }
        return getPlatformShipmentReasons1Response, nil
   ...
   // PlatformConfiguration holds PlatformConfiguration object properties
    ...
    // CreateApplication Create new sales channel
    ...
    // GetIntegrationById Get integration data by integration id
    ...
    // GetOtherSellerApplicationById Get other seller sales channel
    ...
    // OptOutFromApplication UpdateOpt out company or store from other seller sales channel
