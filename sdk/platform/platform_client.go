...
type PlatformClient struct {
	config            *PlatformConfig
		...
		OrderInvoiceEngine  *PlatformOrderInvoiceEngine
...
func NewPlatformClient(config *PlatformConfig) *PlatformClient {
		return &PlatformClient{
			config: config,
				...
				OrderInvoiceEngine:  NewPlatformOrderInvoiceEngine(config),
...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformPayment holds PlatformPayment object properties
    ...
    // GetPayoutPennyDropAndChequeConfig Payout config for penny drop and cancel cheque upload
     func (pa *PlatformPayment)  GetPayoutPennyDropAndChequeConfig() (PayoutPennyDropAndChequePayload, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getPayoutPennyDropAndChequeConfigResponse PayoutPennyDropAndChequePayload
	    )
        ...
        rawRequest = NewRequest(
            pa.Config,
            "get",
            fmt.Sprintf("/service/platform/payment/v1.0/company/%s/payout/bank/config",pa.CompanyID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
             return PayoutPennyDropAndChequePayload{}, err
	    }
        
        err = json.Unmarshal(response, &getPayoutPennyDropAndChequeConfigResponse)
        if err != nil {
             return PayoutPennyDropAndChequePayload{}, common.NewFDKError(err.Error())
        }
        return getPayoutPennyDropAndChequeConfigResponse, nil
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    // GetInventoryBySize Get Inventory for company
     func (ca *PlatformCatalog)  GetInventoryBySize(ItemID string, Size string, xQuery PlatformGetInventoryBySizeXQuery) (InventoryResponsePaginated, error){
    ...
    // GetInventoryBySizeIdentifier Get Inventory for company
     func (ca *PlatformCatalog)  GetInventoryBySizeIdentifier(ItemID string, SizeIdentifier string, xQuery PlatformGetInventoryBySizeIdentifierXQuery) (InventorySellerIdentifierResponsePaginated, error){
   ...
   // PlatformCompanyProfile holds PlatformCompanyProfile object properties
    ...
    // GetCompanyRestrictedCategoryInfo Get restricted category info
     func (co *PlatformCompanyProfile)  GetCompanyRestrictedCategoryInfo() (RestrictedCategoryMetricsResponseSerializer, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getCompanyRestrictedCategoryInfoResponse RestrictedCategoryMetricsResponseSerializer
	    )
        ...
        rawRequest = NewRequest(
            co.Config,
            "get",
            fmt.Sprintf("/service/platform/company-profile/v1.0/company/%s/restricted-categories/metrics",co.CompanyID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
             return RestrictedCategoryMetricsResponseSerializer{}, err
	    }
        
        err = json.Unmarshal(response, &getCompanyRestrictedCategoryInfoResponse)
        if err != nil {
             return RestrictedCategoryMetricsResponseSerializer{}, common.NewFDKError(err.Error())
        }
        return getCompanyRestrictedCategoryInfoResponse, nil
    ...
    // GetCompanyRestrictedCategoryInfoOfOneType Get restricted category info
     func (co *PlatformCompanyProfile)  GetCompanyRestrictedCategoryInfoOfOneType() (RestrictedCategoryListResponseSerializer, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getCompanyRestrictedCategoryInfoOfOneTypeResponse RestrictedCategoryListResponseSerializer
	    )
        ...
        rawRequest = NewRequest(
            co.Config,
            "get",
            fmt.Sprintf("/service/platform/company-profile/v1.0/company/%s/restricted-category/",co.CompanyID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
             return RestrictedCategoryListResponseSerializer{}, err
	    }
        
        err = json.Unmarshal(response, &getCompanyRestrictedCategoryInfoOfOneTypeResponse)
        if err != nil {
             return RestrictedCategoryListResponseSerializer{}, common.NewFDKError(err.Error())
        }
        return getCompanyRestrictedCategoryInfoOfOneTypeResponse, nil
    ...
    // CreateCompanyRestrictedCategoryDocument Create restricted category info
     func (co *PlatformCompanyProfile)  CreateCompanyRestrictedCategoryDocument() (SuccessResponseSerializer, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            createCompanyRestrictedCategoryDocumentResponse SuccessResponseSerializer
	    )
        ...
        rawRequest = NewRequest(
            co.Config,
            "post",
            fmt.Sprintf("/service/platform/company-profile/v1.0/company/%s/restricted-categories/document",co.CompanyID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
             return SuccessResponseSerializer{}, err
	    }
        
        err = json.Unmarshal(response, &createCompanyRestrictedCategoryDocumentResponse)
        if err != nil {
             return SuccessResponseSerializer{}, common.NewFDKError(err.Error())
        }
        return createCompanyRestrictedCategoryDocumentResponse, nil
    ...
    // UpdateCompanyRestrictedCategoryDocument Update restricted category info
     func (co *PlatformCompanyProfile)  UpdateCompanyRestrictedCategoryDocument(DocumentID string) (SuccessResponseSerializer, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateCompanyRestrictedCategoryDocumentResponse SuccessResponseSerializer
	    )
        ...
        rawRequest = NewRequest(
            co.Config,
            "put",
            fmt.Sprintf("/service/platform/company-profile/v1.0/company/%s/restricted-categories/document/%s",co.CompanyID, DocumentID),
            nil,
            nil,
            nil)
        response, err = rawRequest.Execute()
        ...
        err = json.Unmarshal(response, &updateCompanyRestrictedCategoryDocumentResponse)
        if err != nil {
             return SuccessResponseSerializer{}, common.NewFDKError(err.Error())
        }
        return updateCompanyRestrictedCategoryDocumentResponse, nil
   ...
   // PlatformOrders holds PlatformOrders object properties
    type PlatformOrders struct {
        Config *PlatformConfig
        CompanyID string
    }
    // NewPlatformOrders returns new PlatformOrders instance
    func NewPlatformOrders(config *PlatformConfig) *PlatformOrders {
        return &PlatformOrders{Config: config, CompanyID: config.CompanyID}
    }
    ...
    // GetShipmentDetails 
     func (or *PlatformOrders)  GetShipmentDetails(ShipmentID string, xQuery PlatformGetShipmentDetailsXQuery) (ShipmentInfoResponse, error){
    ...
    //PlatformGetShipmentToManifestXQuery holds query params
    type PlatformGetShipmentToManifestXQuery struct { 
        GroupEntity string  `url:"group_entity,omitempty"` 
        SalesChannel string  `url:"sales_channel,omitempty"` 
        DpIds string  `url:"dp_ids,omitempty"`  
    }
    ...
    // GetShipmentToManifest 
     func (or *PlatformOrders)  GetShipmentToManifest(xQuery PlatformGetShipmentToManifestXQuery) (ManifestShipmentResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            getShipmentToManifestResponse ManifestShipmentResponse
	    )
        ...
        rawRequest = NewRequest(
            or.Config,
            "get",
            fmt.Sprintf("/service/platform/orders/v1.0/company/%s/manifest-listing",or.CompanyID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
        if err != nil {
             return ManifestShipmentResponse{}, err
	    }
        
        err = json.Unmarshal(response, &getShipmentToManifestResponse)
        if err != nil {
    ...
    // GetMetricCount 
     func (or *PlatformOrders)  GetMetricCount(xQuery PlatformGetMetricCountXQuery) (MetricCountResponse, error){
    ...
    // Getfilters 
     func (or *PlatformOrders)  Getfilters(xQuery PlatformGetfiltersXQuery) (FiltersResponse, error){
    ...
    // CreateShipmentReport 
     func (or *PlatformOrders)  CreateShipmentReport(xQuery PlatformCreateShipmentReportXQuery) (Success, error){
    ...
    // GetReportsShipmentListing 
     func (or *PlatformOrders)  GetReportsShipmentListing(xQuery PlatformGetReportsShipmentListingXQuery) (OmsReports, error){
    ...
    // UpsertJioCode 
     func (or *PlatformOrders)  UpsertJioCode(body  JioCodeUpsertPayload) (JioCodeUpsertResponse, error){
   ...
   // PlatformOrderInvoiceEngine holds PlatformOrderInvoiceEngine object properties
    type PlatformOrderInvoiceEngine struct {
        Config *PlatformConfig
        CompanyID string
    }
    // NewPlatformOrderInvoiceEngine returns new PlatformOrderInvoiceEngine instance
    func NewPlatformOrderInvoiceEngine(config *PlatformConfig) *PlatformOrderInvoiceEngine {
        return &PlatformOrderInvoiceEngine{Config: config, CompanyID: config.CompanyID}
    }
    ...
    // GenerateBulkPackageLabel Generate Labels for Packages
     func (or *PlatformOrderInvoiceEngine)  GenerateBulkPackageLabel(body  GenerateBulkPackageLabel) (SuccessResponseGenerateBulk, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "post",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/generate-bulk-package-label",or.CompanyID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
    ...
    // GenerateBulkBoxLabel Generate Labels for Boxes which will go inside package
     func (or *PlatformOrderInvoiceEngine)  GenerateBulkBoxLabel(body  GenerateBulkBoxLabel) (SuccessResponseGenerateBulk, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "post",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/generate-bulk-box-label",or.CompanyID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
    ...
    // GenerateBulkShipmentLabel Generate Labels for Shipments which contains packaged
     func (or *PlatformOrderInvoiceEngine)  GenerateBulkShipmentLabel(body  GenerateBulkShipmentLabel) (SuccessResponseGenerateBulk, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "post",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/generate-bulk-shipment-label",or.CompanyID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
    ...
    // GenerateNoc Generate NOC for Seller having access to a fullfillment center
     func (or *PlatformOrderInvoiceEngine)  GenerateNoc(body  GenerateNoc) (SuccessResponseGenerateBulk, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "post",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/generate-noc",or.CompanyID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
    ...
    // GetLabelStatus Get Staus of Label generations
     func (or *PlatformOrderInvoiceEngine)  GetLabelStatus(xQuery PlatformGetLabelStatusXQuery) (StatusSuccessResponse, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "get",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/get-label-list",or.CompanyID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // GetNocStatus Get Staus of NOC generation
     func (or *PlatformOrderInvoiceEngine)  GetNocStatus(xQuery PlatformGetNocStatusXQuery) (StatusSuccessResponse, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "get",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/get-noc-status",or.CompanyID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // GetLabelPresignedURL Get Presigned URL to download labels
     func (or *PlatformOrderInvoiceEngine)  GetLabelPresignedURL(xQuery PlatformGetLabelPresignedURLXQuery) (SignedSuccessResponse, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "get",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/get-label-presigned-url",or.CompanyID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
    ...
    // GetNocPresignedURL Get Presigned URL to download NOC Pdf
     func (or *PlatformOrderInvoiceEngine)  GetNocPresignedURL(xQuery PlatformGetNocPresignedURLXQuery) (SignedSuccessResponse, error){
        ...
        rawRequest = NewRequest(
            or.Config,
            "get",
            fmt.Sprintf("/service/platform/invoice/v1.0/company/%s/get-noc-presigned-url",or.CompanyID),
            nil,
            xQuery,
            nil)
        response, err = rawRequest.Execute()
