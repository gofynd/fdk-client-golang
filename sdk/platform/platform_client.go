...
// NewPlatformClient returns platform level services instance
...
func (p *PlatformClient) NewApplicationClient(appID string) *ApplicationClient {
	return NewApplicationClient(appID, p.config)
}
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    // ListProductTemplateExportDetails Allows you to list all product templates export list details
     func (ca *PlatformCatalog)  ListProductTemplateExportDetails(
        ...
        var (
            ...
            listProductTemplateExportDetailsResponse TemplatesResponse
    ...
    // ListTemplateBrandTypeValues Allows you to list all values for Templates, Brands or Type
     func (ca *PlatformCatalog)  ListTemplateBrandTypeValues(
         xQuery PlatformListTemplateBrandTypeValuesXQuery) (ProductConfligurationDownloads, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            
            listTemplateBrandTypeValuesResponse ProductConfligurationDownloads
        ...
        if err != nil {
             ...
             return ProductConfligurationDownloads{}, err
            
	    }
        err = json.Unmarshal(response, &listTemplateBrandTypeValuesResponse)
        if err != nil {
           
             return ProductConfligurationDownloads{}, common.NewFDKError(err.Error())
    ...
    // DeleteSize Delete a Size associated with product.
     func (ca *PlatformCatalog)  DeleteSize(
         ItemID float64, Size float64) (SuccessResponse, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            
            deleteSizeResponse SuccessResponse
    ...
    // GetInventory Get Inventory for company
     func (ca *PlatformCatalog)  GetInventory(
         ItemID string, Size string, xQuery PlatformGetInventoryXQuery) (InventoryRequest, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            
            getInventoryResponse InventoryRequest
        ...
        if err != nil {
             ...
             return InventoryRequest{}, common.NewFDKError(err.Error())
    ...
    // AddInventory Add Inventory for particular size and store.
     func (ca *PlatformCatalog)  AddInventory(
         ItemID float64, Size string, body  InventoryRequest1) (SuccessResponse, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
    ...
    // GetInventoryBulkUploadHistory Get a list of all bulk Inventory upload jobs.
     func (ca *PlatformCatalog)  GetInventoryBulkUploadHistory(
         xQuery PlatformGetInventoryBulkUploadHistoryXQuery) (BulkRequestGet, error){
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            
            getInventoryBulkUploadHistoryResponse BulkRequestGet
        ...
        if err != nil {
             ...
             return BulkRequestGet{}, err
            
	    }
        err = json.Unmarshal(response, &getInventoryBulkUploadHistoryResponse)
        if err != nil {
           
             return BulkRequestGet{}, common.NewFDKError(err.Error())
    ...
    // UpdateHsnCode Update Hsn Code.
     func (ca *PlatformCatalog)  UpdateHsnCode(
        ...
        rawRequest = NewRequest(
            ca.Config,
            "put",
            fmt.Sprintf("/service/platform/catalog/v1.0/company/%s/hsn/{uid}/",ca.CompanyID, ID),
            nil,
            nil,
            reqBody)
        response, err = rawRequest.Execute()
