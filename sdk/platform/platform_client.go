...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    // CreateProduct Create a product.
     func (ca *PlatformCatalog)  CreateProduct(body  ProductCreateUpdateV2) (SuccessResponse, error){
    ...
    // EditProduct Edit a product.
     func (ca *PlatformCatalog)  EditProduct(ItemID float64, body  ProductCreateUpdateV2) (SuccessResponseProduct, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            editProductResponse SuccessResponseProduct
	    )
    ...
    // UpdateRealtimeInventory Add Inventory for particular size and store.
     func (ca *PlatformCatalog)  UpdateRealtimeInventory(ItemID float64, SellerIdentifier string, body  InventoryRequestSchemaV2) (SuccessResponse, error){
        
        var (
            rawRequest  *RawRequest
            response    []byte
            err         error
            updateRealtimeInventoryResponse SuccessResponse
	    )
