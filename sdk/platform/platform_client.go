...
func (p *PlatformClient) SetPlatformApplicationClient(appID string) {
   ...
   // PlatformCatalog holds PlatformCatalog object properties
    ...
    //PlatformCreateBulkProductUploadJobXQuery holds query params
    type PlatformCreateBulkProductUploadJobXQuery struct { 
        Department string  `url:"department,omitempty"` 
    ...
    // CreateBulkProductUploadJob Create a Bulk product to upload job.
     func (ca *PlatformCatalog)  CreateBulkProductUploadJob(xQuery PlatformCreateBulkProductUploadJobXQuery, body  BulkJob) (BulkResponse, error){
